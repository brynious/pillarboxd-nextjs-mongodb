...
const main = async () => {
  ...
  try {
    ...
    const seriesTmdbIds = [
      ...
      // { tmdb_id: 42009, approved_specials: [] }, // Black Mirror
      ...
      { tmdb_id: 60554, approved_specials: [] }, // Star Wars Rebels
    ...
    for (const series of seriesTmdbIds) {
      ...
      if (!seriesData.origin_country.includes('US')) continue;
